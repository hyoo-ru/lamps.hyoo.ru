...
;
	($.$hyoo_lamps) = class $hyoo_lamps extends ($.$mol_book2) {
		plugins(){
			return [(this.Theme())];
		}
		lamp_current_id(next){
			if(next !== undefined) return next;
			return "";
		}
		pages(){
			return [(this.Addon_page()), (this.Main_page("0"))];
		}
		Theme(){
		...
		Source(){
			...
			(obj.uri) = () => ("https://github.com/hyoo-ru/lamps.hyoo.ru");
			return obj;
		}
		Lights(){
		...
		lamp_rows(){
			return [(this.Filter()), (this.Lamp_row("0"))];
		}
		Menu(){
			const obj = new this.$.$mol_list();
		...
		Addon_page(){
			...
			(obj.body_scroll_top) = (next) => ((this.menu_scroll_top(next)));
	...
	($mol_mem(($.$hyoo_lamps.prototype), "lamp_current_id"));
	($mol_mem(($.$hyoo_lamps.prototype), "Theme"));
	($mol_mem(($.$hyoo_lamps.prototype), "menu_scroll_top"));
	($mol_mem(($.$hyoo_lamps.prototype), "Source"));
	($mol_mem(($.$hyoo_lamps.prototype), "Lights"));
	($mol_mem(($.$hyoo_lamps.prototype), "filter"));
	($mol_mem(($.$hyoo_lamps.prototype), "Filter"));
	($mol_mem_key(($.$hyoo_lamps.prototype), "Lamp_row_dimmer"));
	($mol_mem_key(($.$hyoo_lamps.prototype), "Lamp_row"));
	($mol_mem(($.$hyoo_lamps.prototype), "Menu"));
	($mol_mem(($.$hyoo_lamps.prototype), "Addon_page"));
	($mol_mem(($.$hyoo_lamps.prototype), "Close_icon"));
	($mol_mem(($.$hyoo_lamps.prototype), "Close"));
	($mol_mem(($.$hyoo_lamps.prototype), "Rating"));
	($mol_mem(($.$hyoo_lamps.prototype), "Stat"));
	($mol_mem(($.$hyoo_lamps.prototype), "Wattage"));
	($mol_mem(($.$hyoo_lamps.prototype), "Props"));
	($mol_mem(($.$hyoo_lamps.prototype), "Type"));
	($mol_mem(($.$hyoo_lamps.prototype), "Shape"));
	($mol_mem(($.$hyoo_lamps.prototype), "Base"));
	($mol_mem(($.$hyoo_lamps.prototype), "Body"));
	($mol_mem(($.$hyoo_lamps.prototype), "Temp"));
	($mol_mem(($.$hyoo_lamps.prototype), "Cri"));
	($mol_mem(($.$hyoo_lamps.prototype), "Ripple"));
	($mol_mem(($.$hyoo_lamps.prototype), "Angle"));
	($mol_mem(($.$hyoo_lamps.prototype), "Light"));
	($mol_mem(($.$hyoo_lamps.prototype), "Info"));
	($mol_mem(($.$hyoo_lamps.prototype), "Photo"));
	($mol_mem(($.$hyoo_lamps.prototype), "Gallery"));
	($mol_mem_key(($.$hyoo_lamps.prototype), "Main_page"));
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_lamps extends $.$hyoo_lamps {
            ...
            lamps() {
                return this.lamps_all().filter($mol_match_text(this.filter(), (lamp) => {
            ...
            pages() {
                ...
                if (this.lamp() !== null)
                    sub.push(this.Main_page(this.lamp()));
                return sub;
            }
            Placeholder() {
